...
import { sqliteTable, text, integer, check, real, index } from 'drizzle-orm/sqlite-core';
...
// Relationships
// *******************************************
export const userStock = sqliteTable('user_stock', { // Join table on user and stocks
  userId: integer()
    .references(() => user.id, { onDelete: 'set null' })
    .notNull(),
  stockId: integer()
